...
export default function Footer() {
  return (
    <footer className="lsd-footer">
      <div className="lsd-footer__inner">
        <div className="lsd-footer__grid">
          {/* Info column */}
          <div>
            <Image
              ...
              width={200}
              height={52}
              className="lsd-footer__logo-img"
            />
            <div className="lsd-footer__links">
              {infoLinks.map((link) => (
                <Link key={link.label} href={link.href} className="lsd-footer__link">
                  {link.label}
                </Link>
              ))}
            </div>
        ...
        <div className="lsd-footer__bottom">
